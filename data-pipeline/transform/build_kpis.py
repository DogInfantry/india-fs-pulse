...
def pipeline_meta() -> dict:
    ...
    if PROVENANCE.exists():
        ...
        # The footer calls these "public sources", so a dataset this repository
        # generated itself is not one. The synthetic survey panel keeps its
        # provenance row; it just does not get counted as a publisher.
        publishers = {v["publisher"] for v in ledger.values()
                      if v.get("publisher") and "Generated by this repository" not in v["publisher"]}
