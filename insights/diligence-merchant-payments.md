...
**1. Market attractiveness is not the constraint; price is.** 50,705,249 merchants
each running 487 transactions a quarter is a distribution asset most lenders
...
**3. The only listed pure-play has not solved it yet.** One97 Communications (Paytm) reported Rs 8,192 crore of revenue in FY2026 at a 6.8% net margin. A sponsor cannot underwrite this deal on a 'payments scale economics' thesis when the largest listed comparable, with a decade of scale, still earns a thin return on the payments business itself.
