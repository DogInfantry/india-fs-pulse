...
In FY2026 the transaction business, One97 (Paytm), turned its first profit, at 6.8% net margin. It did so on revenue **17.0% below its own FY2024 peak**, which is the shape of a business that got better by getting smaller. In the same
year Angel One earned **21.2%** and
PB Fintech **9.9%** selling distribution, and
CDSL, which operates the piece of market infrastructure that **is** permitted
to charge a toll, earned **39.8%**. Every distribution business in the panel earns a wider margin than the transaction business.
...
One97 (Paytm) carries the largest revenue of the four at
Rs 8,192 crore and converts the least of it, 6.8%,
against 21.2% at the best distribution business: a gap of
14.5 percentage points. Scale is not the constraint. Price is, which is what
sub-module A said from the volume side and what sub-module H priced at
63.9% of transactions earning nothing.

**2. Infrastructure that may charge a toll earns like infrastructure that may charge a
toll.** CDSL runs on the smallest revenue in the panel,
Rs 1,145 crore, and returns 39.8%. It is the
